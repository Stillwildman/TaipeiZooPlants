...
public class ItemZooVenue {

    /**
     * result : {"limit":5,"offset":13,"count":18,"sort":"","results":[{"E_Pic_URL":"http://www.zoo.gov.tw/iTAP/05_Exhibit/14_PandaHouse.jpg","E_Geo":"MULTIPOINT ((121.5830956 24.9968265))","E_Info":"新光特展館（大貓熊館）包括一個戶外場地和兩個室內場地，提供多樣的活動空間及攀爬、遮蔭設施，還有大小石塊及流瀑水。戶外場地則模擬大貓熊野外棲息地，草坪寬闊，並以濃綠喬木構成背景。","E_no":"14","E_Category":"室內區","E_Name":"新光特展館（大貓熊館）","E_Memo":"每月第一個週一休館","_id":14,"E_URL":"http://www.zoo.gov.tw/introduce/gq.aspx?tid=8"},{"E_Pic_URL":"http://www.zoo.gov.tw/iTAP/05_Exhibit/15_PangolinDome.jpg","E_Geo":"MULTIPOINT ((121.5828662 24.9967279))","E_Info":"位在熱帶雨林區的熱帶雨林室內館（穿山甲館），使用臺灣穿山甲為主要意象，不僅是外觀設計的主要視覺焦點，更同時結合節能減碳、太陽能光電、雨水回收系統以及節能空調設計，是一座符合生物多樣性概念的展館。以南美洲亞馬遜河流域環境為展示主軸，顯現熱帶雨林的生物多樣性特色與氛圍。藉由高層空間，融合水域、樹林、樹冠層的沉浸式複合生態系，以不同感官體驗雨林多樣的生物組成，了解保育雨林的重要性，進而支持參與雨林保育。","E_no":"15","E_Category":"室內區","E_Name":"熱帶雨林室內館（穿山甲館）","E_Memo":"","_id":15,"E_URL":"http://www.zoo.gov.tw/introduce/gq.aspx?tid=11"},{"E_Pic_URL":"http://www.zoo.gov.tw/iTAP/05_Exhibit/16_EcoHouse.jpg","E_Geo":"MULTIPOINT ((121.5742216 24.9946471))","E_Info":"經濟部能源局及工業技術研究院，結合臺北市立動物園的環境教育及生態保育理念，建造這一棟位於沙漠動物區入口處的酷Cool節能屋。這是一座結合空間設計、節能材料及再生能源利用的節能建築，導入童話故事的解說活動，適合全家人一起來體驗。","E_no":"16","E_Category":"特展區","E_Name":"酷Cool節能屋","E_Memo":"每週一休館","_id":16,"E_URL":"http://www.zoo.gov.tw/introduce/gq.aspx?tid=21"},{"E_Pic_URL":"http://www.zoo.gov.tw/iTAP/05_Exhibit/17_Gao.jpg","E_Geo":"MULTIPOINT ((121.5855552 24.9953692))","E_Info":"臺北市立動物園現址原名為「頭廷魁」，主要為高氏族人的聚落。民國68年為新建動物園工程，徵收該地，市政府為照顧居民生計，在園外設立販賣區提供高氏族人經營，並於販賣區2樓設置高氏宗祠。後因販賣區改建，遂將高氏宗祠遷移至現址並成立高氏宗祠文史館，並於民國104年1月6日正式開放民眾參觀。高氏宗祠文史館除提供高氏後代子孫祭祀之用，更成為民眾了解在地歷史文化的展示空間。","E_no":"17","E_Category":"特展區","E_Name":"高氏宗祠文史館","E_Memo":"開放參觀時間：每週二上午9:00-12:00，若遇例假日則停止開放。","_id":17,"E_URL":"http://www.zoo.gov.taipei/ct.asp?xItem=115806228＆ctNode=71644＆mp=104031"},{"E_Pic_URL":"http://www.zoo.gov.tw/iTAP/05_Exhibit/18_TheStage.jpg","E_Geo":"MULTIPOINT ((121.5826075 24.9987238))","E_Info":"為了讓更多的市民貼近、瞭解大自然，同時寓教於樂，兒童動物區內的特展區「生命驛站」，希望透過農田環境、動物標本和農具展示，以及自導式互動遊戲，呈現大自然萬物的生命循環歷程，讓參觀者感受生命與環境間的重要關聯。","E_no":"18","E_Category":"特展區","E_Name":"生命驛站","E_Memo":"每週六、日13:30-15:30開放參觀","_id":18,"E_URL":"https://www.zoo.gov.taipei/cp.aspx?n=274AFEA1B85B9D7B"}]}
     */
    ...
    public static class Result {
        ...
        private List<ItemVenueInfo> venueInfoList;
        ...
        public List<ItemVenueInfo> getVenueInfoList() {
            return venueInfoList;
        }

        public static class ItemVenueInfo {
            /**
